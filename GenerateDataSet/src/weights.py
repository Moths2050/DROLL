...
def parker_weights_2d(geometry):
    ...
    beta = (np.pi + 2 * geometry.fan_angle)/2.0 - (geometry.proj_range_end - geometry.proj_range_start)/2.0  # adds offset
    ...
    scale_factor = np.abs(geometry.angular_range + geometry.angular_range  / geometry.number_of_projections) / np.pi
