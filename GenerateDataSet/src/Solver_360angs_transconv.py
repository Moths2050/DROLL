...
from src import FBP_Net_NetWorks_TransConv
...
class Solver(object):
    def __init__(self, args, data_loader):
        ...
        self.FBP_Net = FBP_Net_NetWorks_TransConv.FBP_Net(args)
        # print(self.FBP_Net)
    ...
    def test(self):
        del self.FBP_Net
        # load
        self.FBP_Net = FBP_Net_NetWorks_TransConv.FBP_Net(self.args ).to(self.device)
